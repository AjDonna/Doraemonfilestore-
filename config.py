...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6991378012:AAGCiqDybnxab6OXXmiB3pSU9NNVYnP-AcA")
...
try:
    ADMINS=[6066102279]
    for x in (os.environ.get("ADMINS", "1919633191 5866116911 5574593875").split()):
        ADMINS.append(int(x))
except ValueError:
